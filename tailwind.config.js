...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        // Same stack as index.css — see MOD-FIX-029 there for why the
        // generic fallback was not enough.
        sans: ['Vazirmatn', 'Vazir', 'IRANSans', 'IRANYekan', 'Segoe UI', 'Tahoma', 'system-ui', 'sans-serif'],
      },
      borderRadius: {
        ios: '14px',
        'ios-lg': '22px',
